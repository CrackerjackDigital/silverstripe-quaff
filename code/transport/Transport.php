...
abstract class Transport extends Object implements TransportInterface {
	 ...
	 */
	public static function make_response(Endpoint $endpoint, $resultCode, $rawData, array $metaData = []) {
		...
		return \Injector::inst()->create(
			...
			array_merge(
				[
					self::MetaResponseCode  => $resultCode,
	 ...
	 * @return mixed
	 */
	protected static function native_options($type, $moreOptions = []) {
